            ...
            <div class="modal-body">
                <form action="#" method="POST" class="formulario" id="pago">
                    ...
                    <div>
                        ...
                        ?>
                            <label for="nombre" class="form-label login__label"> Seleccione una Direccion </label>
                            <select class="form-select mb-3" name="id_direccion" id="provincia">
                                <?php while ($datos_dir = mysqli_fetch_array($cant_dir)) { ?>
                                    <option value=<?= $datos_dir['id_direccion'] ?>><?= $datos_dir['direccion'] ? $datos_dir['direccion'] : 'No hay direcciones' ?></option>
                                <?php } ?>
                            </select>
                        <?php  } ?>

                        <label for="nombre" class="form-label login__label"> Seleccione Método de Pago </label>
                        <select class="form-select mb-3" name="id_metodo_pago" id="buscar-banco">
                            <?php while ($metodo = mysqli_fetch_array($datosM)) { ?>
                        ...
                        <div class="formulario__grupo" id="grupo__referencia_p">
                            <label for="referencia_p" class="form-label login__label"> Ingrese la Referencia del Pago </label>
