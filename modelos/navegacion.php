<?php
    class ModeloDeNavegacion {
        ...
        static public function enlacesPaginasM($enlace) {
            ...
            // administrador
            } else if ($enlace == "reportes" || $enlace == "registrar-producto" || $enlace == "editar-producto" || $enlace == "lista-productos" || $enlace == "lista-categorias" || $enlace == "editar-categoria" || $enlace == "registrar-categoria") {
